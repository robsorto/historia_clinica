...
?>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box">
              ...
              <div class="panel-body" style="height: 400px;" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-5 col-md-5 col-sm-12 col-xs-12">
                    ...
                    <input type="number" disabled="true" class="form-control" name="documento" id="documento" required="">
                  </div>
                  <div class="form-group col-lg-5 col-md-5 col-sm-12 col-xs-12">
                  ...
                  <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12">
                    <label>-</label>
                    <button type="button" data-toggle="modal" href="#busqueda-paciente-modal" class="btn btn-info">Consultar</button>
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        ...
                        <select id="idempleado" name="idempleado" class="form-control selectpicker" data-live-search="true">
              ...
              <div class="panel-body" id="formularioregistrosEdicion">
                <form name="formularioActualizacion" id="formularioActualizacion" method="POST">
                  ...
                  <div id="atencion-content">
                    ...
                    <div class="row text-center">
                      <div class="col-lg-6 col-md-6 col-sm-12 col-lg-offset-3 col-md-offset-3">
                        <label for="atencionRealizada">Atención Realizada</label>
                        <input type="text" name="atencionRealizada" id="atencionRealizada" disabled="true" class="form-control" />
                      </div>
                    </div>
                    <br />
                    <div class="row">
                      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                        <label for="pacienteAtencion">Paciente</label>
                        <input type="text" readonly id="pacienteAtencion" class="form-control" name="pacienteAtencion">
                      </div>
                      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                        <label for="dniAtencion">Documento</label>
                        <input type="text" readonly id="dniAtencion" class="form-control" name="dniAtencion">
                      </div>
                      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                        <label for="edadAtencion">Edad</label>
                        <input type="text" readonly id="edadAtencion" class="form-control" name="edadAtencion">
                      </div>
                      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                        <label for="especialistaAtencion">Especialista</label>
                        <input type="text" readonly id="especialistaAtencion" class="form-control" name="especialistaAtencion">
                      </div>
                      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                        <label for="servicioAtencion">Servicio</label>
                        <input type="text" readonly id="servicioAtencion" class="form-control" name="servicioAtencion">
                      </div>
                    </div>
                    <br />
                    <div class="row">
                      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                        <label for="presion_arterialAtencion">Presión Arterial (mmhg)</label>
                        <input type="text" id="presion_arterialAtencion" class="form-control" name="presion_arterialAtencion">
                      </div>
                      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                        <label for="temperaturaAtencion">Temperatura (&deg;C)</label>
                        <input type="text" id="temperaturaAtencion" class="form-control" name="temperaturaAtencion">
                      </div>
                      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                        <label for="frecuencia_respiratoriaAtencion">Frecuencia Respiratoria (x')</label>
                        <input type="text" id="frecuencia_respiratoriaAtencion" class="form-control" name="frecuencia_respiratoriaAtencion">
                      </div>
                      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                        <label for="frecuencia_cardiacaAtencion">Frecuencia Cardiaca (x')</label>
                        <input type="text" id="frecuencia_cardiacaAtencion" class="form-control" name="frecuencia_cardiacaAtencion">
                      </div>
                      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        <label for="saturacionAtencion">Saturación (%)</label>
                        <input type="text" id="saturacionAtencion" class="form-control" name="saturacionAtencion">
                      </div>
                      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                        <label for="pesoTAtencion">Peso (Kg)</label>
                        <input type="text" id="pesoTAtencion" class="form-control" name="pesoTAtencion">
                      </div>
                      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                        <label for="tallaTAtencion">Talla (Cm)</label>
                        <input type="text" id="tallaTAtencion" class="form-control" name="tallaTAtencion">
                      </div>
                      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                        <label for="imcTAtencion">IMC</label>
                        <input type="text" id="imcTAtencion" class="form-control" name="imcTAtencion">
                      </div>
                      <div class="form-group col-lg-2 col-md-2 col-sm-12 col-xs-12">
                        <label>Estado:</label>
                        <input type="text" class="form-control" name="estadoTAtencion" id="estadoTAtencion" maxlength="256" placeholder="estado" disabled="">
                      </div>
                    </div>
                  </div>
                  ...
                  <div id="general-content" class="d-none">
                    ...
                    <div class="row">
                      <div class="form-group col-lg-6 col-md-56 col-sm-12 col-xs-6">
                        ...
                        <input type="hidden" class="form-control" name="idresultadoEdicion" id="idresultadoEdicion">
                        <input type="hidden" class="form-control" name="idatencionEdicion" id="idatencionEdicion">
                  ...
                  <div id="ginecologia-content" class="d-none">
                    <div class="panel-body">
                      ...
                      <input type="hidden" class="form-control" name="idginecologia" id="idginecologia">
                      <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                  ...
                  <div id="receta-content" class="d-none">
                    ...
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" id="actualizar">
    ...
    <!--Fin-Contenido-->
    <div class="modal fade" id="busqueda-paciente-modal" tabindex="-1" role="dialog" aria-labelledby="text-modal-busqueda" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content modal-lg">
          <form id="modal-busqueda-paciente">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">
                <span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span>
              </button>
              <h4 class="modal-title" id="text-modal-busqueda">Buqueda de pacientes</h4>
            </div>
            <div class="modal-body">
              <div class="row">
                <label class="radio-inline">Criterio de busqueda:</label>
                <label class="radio-inline">
                  <input type="radio" id="documentoBusqueda" name="busqueda" value="documento" checked>Documento
                </label>
                <label class="radio-inline">
                  <input type="radio" id="nombreBusqueda" name="busqueda" value="nombre">Nombres
                </label>
                <label class="radio-inline">
                  <input type="radio" id="telefonoBusqueda" name="busqueda" value="telefono">Telefono
                </label>
                <label class="radio-inline">
                  <input type="radio" id="correoBusqueda" name="busqueda" value="correo">Correo electrónico
                </label>

                <div class="col-lg-6 col-md-6">
                  <br />
                  <label for="texto-busqueda">Texto a buscar</label>
                  <input type="text" id="texto-busqueda" name="texto-busqueda" required class="form-control">
                </div>
                <div class="col-lg-4 col-md-4">
                  <br />
                  <label for="texto-busqueda">-</label>
                  <input type="submit" id="buscar-criterio" class="btn btn-primary form-control" value="Buscar">
                </div>
                <div class="col-lg-12 col-md-12">
                  <br />
                  <table id="table-resultado-busqueda" class="table table-striped">
                    <thead>
                      <tr>
                        <th>DOCUMENTO</th>
                        <th>NOMBRES</th>
        ...
        <div class="modal-content modal-lg">
          <form id="modal-control-prenatal">
            ...
            <div class="modal-body">
              ...
              <input type="hidden" id="idcontrolModal" name="idcontrolModal" class="form-control" />
              <div class="row">
