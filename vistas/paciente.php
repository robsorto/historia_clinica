            ...
            <div class="box">
              <div class="box-header with-border">
                ...
                <div class="form-inline" id="dbuscar">
                  <label>Apellido Paterno o Materno o DOCUMENTO UNICO:</label>
              ...
              <div class="panel-body" style="height: 550px;" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <input type="text" class="form-control" name="apaterno" id="apaterno" maxlength="30" placeholder="apellido Paterno">
                  </div>
                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <label>Apellido Materno:</label>
                    <input type="text" class="form-control" name="amaterno" id="amaterno" maxlength="30" placeholder="Apellido Materno">
                  </div>
                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <label>Nombre (*):</label>
